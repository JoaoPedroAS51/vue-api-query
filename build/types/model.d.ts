 ...
 *
 */
export declare type DomainModel<T extends Model<boolean, boolean>> = Required<Omit<T, keyof Omit<Model, ModelOperations>>>;
/**
 * Model Operations
 * ---
 *
 ...
 *
 */
declare type ModelOperations = 'delete' | 'save' | 'attach' | 'sync' | 'for';
/**
 ...
 *
 */
export declare type WrappedModel<T extends Model<boolean, boolean>> = {
    data: DomainModel<T>;
};
/**
 * Model Type
 ...
 *
 */
export declare type TModel<T extends Model<boolean, boolean>> = DomainModel<T> | WrappedModel<T>;
/**
 ...
 *
 */
export declare type WrappedCollection<T extends Model<boolean, boolean>> = {
    data: TModel<T>[];
};
/**
 * Collection Type
 ...
 *
 */
export declare type TCollection<T extends Model<boolean, boolean>> = WrappedCollection<T> | TModel<T>[];
/**
 ...
 *
 */
export declare type QueryResponseModel<T extends Model<boolean, boolean>, M extends boolean = false> = M extends true ? WrappedModel<T> : DomainModel<T>;
/**
 ...
 *
 */
export declare type QueryResponseCollection<T extends Model<boolean, boolean>, C extends boolean = false, M extends boolean = false> = C extends true ? {
